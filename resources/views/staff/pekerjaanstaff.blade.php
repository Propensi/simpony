    ...
    <div class="table">
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            @foreach($assignments0 as $item)
                ...
                <tr>
                    <td>{{ $x }}</td>
                    <td><a href="{{  $item->Assn_ID }}/pekerjaanstaff">{{ $item->Assn_Nama }}</a></td><td> {{ $item->Assn_Deskripsi}} </td>
                    ...
                    <td>
                       ...
                       <a class="btn btn-primary btn-xs" href="{{  $item->Assn_ID }}/pekerjaanstaff">lihat</a>
                        <!-- ini punya Terima-->
